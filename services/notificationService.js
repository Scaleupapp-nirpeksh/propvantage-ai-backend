...
export async function notifyApprovalRejected({
  ...
  return createNotification({
    ...
    message: `${rejectorName} rejected your request: "${approvalRequest.title}"${reason ? ` — Reason: ${reason}` : ''}`,
    actionUrl: `/approvals/${approvalRequest._id}`,
    relatedEntity: {
      entityType: 'ApprovalRequest',
      entityId: approvalRequest._id,
...
export async function notifyApprovalEscalated({
  ...
  return createNotification({
    ...
    message: `Approval request "${approvalRequest.title}" has been escalated to you — SLA breached`,
    actionUrl: `/approvals/${approvalRequest._id}`,
    relatedEntity: {
      entityType: 'ApprovalRequest',
      entityId: approvalRequest._id,
