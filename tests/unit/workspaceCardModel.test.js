...
describe('WorkspaceCard model', () => {
  it('exports the modules and three render modes (incl. insight)', () => {
    expect(WORKSPACE_MODULES).toEqual(['leads', 'sales', 'payments', 'tasks', 'channelPartners', 'projects', 'supportTickets']);
